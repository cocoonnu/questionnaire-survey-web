...
const PropComponent = (props: QuestionSelectProps) => {
  const { title, selectedValue, options = [], onChange, disabled } = props
  const [form] = Form.useForm()

  useEffect(() => {
    form.setFieldsValue({ title, selectedValue, options })
  }, [title, selectedValue, options, form])
